  ...
  return (
    <div
      ...
      <div style={{ gridColumn: 1, gridRow: 2, display: 'flex', flexDirection: 'column' }}>
        ...
        {tags.length > 0 &&
          <div style={{ paddingTop: 14, paddingBottom: 14, borderTop: dividerStyle, borderBottom: dividerStyle, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <p style={{ margin: 0, fontSize: 15, fontWeight: 700, lineHeight: 1.4, color: sc2, whiteSpace: 'normal', wordBreak: 'break-word' }}>

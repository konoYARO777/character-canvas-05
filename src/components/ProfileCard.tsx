    ...
    <div
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{ padding: 14, border: '2px dashed #f4f4f5', borderRadius: 8 }}>
          <span style={{ fontSize: 14, fontWeight: 600, fontFamily: "'Paperozi', sans-serif", textTransform: 'uppercase', letterSpacing: '0.05em', color: pc }}>
            캐릭터 색상
          </span>
        ...
        {tags.length > 0 &&
          <div style={{ padding: 14, border: '2px dashed #f4f4f5', borderRadius: 8 }}>
            ...
            <p style={{ marginTop: 8, fontSize: 12, fontWeight: 600, lineHeight: 1.8, color: sc2, whiteSpace: 'normal', wordBreak: 'break-word' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div>
            ...
            <p style={{ fontSize: 18, fontWeight: 500, color: sc2, marginTop: 4 }}>
              {data.occupation || '직업'}
            </p>
          </div>
        ...
        {/* Stats */}
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 20, padding: '20px 0', borderTop: '1px solid #f4f4f5', borderBottom: '1px solid #f4f4f5' }}>
          {[
            ...
            <div key={item.label}>
              ...
              <p style={{ fontSize: 17, fontWeight: 700, marginTop: 2, color: sc2 }}>
                {item.value || '—'}
              </p>
            </div>
          )}
        ...
        {/* Gallery */}
        <div>
          <span style={{ fontSize: 11, fontWeight: 600, fontFamily: "'Paperozi', sans-serif", textTransform: 'uppercase', letterSpacing: '0.05em', color: pc, marginBottom: 12, display: 'block' }}>
            갤러리
          </span>
        ...
        {hasPersonality &&
          <div style={{ borderTop: '1px solid #f4f4f5', paddingTop: 20 }}>
            ...
            <p style={{ fontSize: 13, lineHeight: 1.7, color: sc2, whiteSpace: 'pre-wrap', wordBreak: 'break-word', overflowWrap: 'break-word' }}>
              {data.personality}
            </p>
          </div>
        }
          ...
          <div style={{ borderTop: '1px solid #f4f4f5', paddingTop: 20 }}>
            {storiesWithContent.map((story, i) =>
              <div key={i} style={{ marginBottom: i < storiesWithContent.length - 1 ? 20 : 0 }}>
                <h3 style={{ fontSize: 16, fontWeight: 700, fontFamily: "'Paperozi', sans-serif", color: pc, marginBottom: 6 }}>
                  {story.title}
                </h3>
                <p style={{ fontSize: 13, lineHeight: 1.7, color: sc2, whiteSpace: 'pre-wrap', wordBreak: 'break-word', overflowWrap: 'break-word' }}>
                  {story.content}
        ...
        {/* Footer */}
        <div style={{ marginTop: 'auto', paddingTop: 24, borderTop: '1px solid #f4f4f5', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
